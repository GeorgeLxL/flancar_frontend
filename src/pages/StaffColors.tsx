...
import { getStaffColors, getStaffs, setStaffColor } from '../api/client';
...
export default function StaffColors() {
    ...
    <div className="min-h-screen bg-white px-4 py-6 sm:px-8 sm:py-10">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
          ...
          {staffs.map(staff => (
            <div key={staff.staffId} className="grid grid-cols-[1.4fr_120px_120px] items-center gap-4 border-b border-gray-50 px-5 py-4 last:border-b-0">
