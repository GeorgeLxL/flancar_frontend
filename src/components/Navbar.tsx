        ...
        {user && (
          <>
            <div className="hidden min-w-0 items-center gap-3 text-sm sm:flex">
              ...
              <button type="button" onClick={handleLogout} className="shrink-0 rounded-xl border border-gray-200 px-3 py-2 text-gray-500 transition-colors hover:bg-gray-50 hover:text-gray-700">
                Logout
              </button>
            </div>

            <div className="flex items-center gap-2 sm:hidden" ref={menuRef}>
              <span className="max-w-[120px] truncate text-sm font-medium text-gray-700">{user.staffName}</span>
              <button
                type="button"
              ...
              {menuOpen && (
                <div className="absolute left-0 right-0 top-full flex flex-col border-b border-gray-100 bg-white shadow-md">
                  ...
                  <button type="button" onClick={handleLogout} className="px-4 py-3 text-left text-sm text-red-500 transition-colors hover:bg-gray-50">
                    Logout
                  </button>
                </div>
              )}
